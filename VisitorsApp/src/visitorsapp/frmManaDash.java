 ...
 * @author Sfiso
 */
public class frmManaDash extends javax.swing.JFrame {

    /**
     * Creates new form frmManaDash
     */
    public frmManaDash() {
        initComponents();
        mViewVisitors();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jspTable, javax.swing.GroupLayout.DEFAULT_SIZE, 733, Short.MAX_VALUE)
                .addContainerGap())
        );
...
frmManaDelete frmMD = new frmManaDelete();
frmMD.show();
...
frmLogin frmL = new frmLogin();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmManaDash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmManaDash().setVisible(true);
            }
        });
    }
